...
_**Doors.**_ All doors in the warded area are magically locked, as if sealed by the [[Arcane Lock]] spell. In addition, you can cover up to ten doors with an illusion to make them appear as plain sections of wall.

_**Stairs.**_ Webs fill all stairs in the warded area from top to bottom, as in the [[Web]] spell. These strands regrow in 10 minutes if they are destroyed while _Guards and Wards_ lasts.
